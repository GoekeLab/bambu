...
colData(se)$groupVar <-  unlist(lapply(colnames(se),function(x) unlist(strsplit(x,"_"))[2]))
colnames(se) <- gsub("_genome_chr22_1_25409234","",colnames(se))
colData(se)$name <- gsub("_genome_chr22_1_25409234","",colData(se)$name)
