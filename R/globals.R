...
if (getRversion() >= "2.15.1") {
    utils::globalVariables(c(
        ...
        "compatible", "confidenceType", "lastExonMatch",
        ...
        "runname", "seqlengths", "firstExonMatch", "strand.rc",
        "subjectCount", "subjectElementsOutsideMaxDist", "sum_nobs", "txId", 
        "tx_id", "tx_name", "uniqueLastExonLengthQuery",
        "uniqueLengthQuery", "uniqueLengthSubject",
        "score","frame","dist","nobs","index",
        "uniqueFirstExonLengthQuery", "value", "valueGene", "valueGeneCPM",
        ...
        "numTstart","numTend","tx_strand_bias", "maxIntronChainScore", 
        ...
        "NSampleIntronChainScore.combined", "NSampleIntronChainScore.new", "maxIntronChainScore.combined",
        "maxIntronChainScore.new" ,"intronChainScore" ,"row_id", "sample_id", 
        "sample_name", "readCount_tmp", "group", "rowID", 
        "sumReadCount", "maxIntronChainScore.noFit", "geneid", 
        "readIds", "readId", "anyCompatible","seqname",
        "eqClassId","K","eqClassById","rcWidth", "minRC",
        "tr_dimension","txid","cumN","gene_grp_id","txlen",
        "maxIntronChainScore.noFit.combined","maxIntronChainScore.noFit.new",
        "intronChainScore.noFit","n.obs","nObs_list","K_list","txids_list",
        "anyEqual","intronChainScore.noFit","txidTemp",
